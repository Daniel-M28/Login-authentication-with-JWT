...
export const register = async (req, res) => {
    try {
        ...
        const existingUserName = await pool.query('SELECT * FROM users WHERE name = $1', [name]);
        ...
        const result = await pool.query("INSERT INTO users (name, email, password) VALUES ($1, $2, $3) RETURNING name, email, role", //returning * para devolver el usuario insertado
